...
| M26 | Goal coordinate, exact distance, recoding and actor/value-side diagnostics | capability committed f0484f4; 10 defined / 8 initially selected / 2 matched references unscheduled; configuration uncommitted; 115 CPU tests and tiny real-data smoke passed; GPU/formal pending | [`M26 Study`](../../experiments/M26_puzzle_goal_coordinate_diagnostics/study.yaml) | [`configuration handoff`](experiments/M26/EXPERIMENT_HANDOFF.md), [`manual release`](experiments/M26/MANUAL_OPERATIONS.md) |

The M26 row is a 2026-09-19 configuration update. Only M24A C003/C005 seed0
attempt001 runtime protocol anchors were re-audited (both record completed);
the older M24A/M22 rows retain their historical campaign-status boundary.
