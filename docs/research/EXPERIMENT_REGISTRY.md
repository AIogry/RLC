...
| M23A | Puzzle direct-rollout behavioral audit | planned; declarative 12-cell controlled-goal-replay campaign prepared; no full results | [`M23A Study`](../../experiments/M23A_puzzle_direct_rollout_audit/study.yaml) | [`M23A authority`](experiments/M23A-F0/README.md) |
